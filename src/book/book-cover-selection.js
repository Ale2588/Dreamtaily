const FRONT_LAYOUTS=Object.freeze({
  Ritratto:{max_title:44,prompt_layout_instruction:"Single coherent full-bleed vertical 2:3 book-cover scene. Place the unique protagonists centred in the middle, facing the viewer, with heads below the upper title-safe quarter. Keep the top quarter and bottom brand strip calm, uncluttered and free of faces or key details."},
  Margine:{max_title:38,prompt_layout_instruction:"Single coherent full-bleed vertical 2:3 book-cover scene. Place every unique protagonist in the lower-right two thirds, safely inside the frame, leaving the upper-left area as quiet negative space with no faces or readable detail."},
  Pannello:{max_title:42,prompt_layout_instruction:"Single coherent full-bleed vertical 2:3 book-cover scene. Place every unique protagonist in the upper-middle area at medium distance. Keep the lower third simple and even in tone for a large editorial title panel and brand strip."}
});
