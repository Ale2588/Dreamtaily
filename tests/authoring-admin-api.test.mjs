...
test("new drafts reserve a generated book cover distinct from the catalog cover",()=>{
  assert.match(source,/book_cover:/);
  assert.match(source,/subtitle: "Un’avventura di \[Nome\]"/);
